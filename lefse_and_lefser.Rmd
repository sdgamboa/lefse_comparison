...
lefser_output <- lefser(
    ...
    groupCol = 'study_condition', blockCol = 'body_site', assay = 2L
) %>% 
...
The number of features reported as significant is not the same for lefser as 
for lefse-conda and lefse-galaxy.
